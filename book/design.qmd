...
- Leitung: Prof. [Benjamin Stocker](https://geco-group.org/author/benjamin-stocker/), Prof. Adrien Mestrot, und Prof. Olivia Romppainen-Martius; Geographisches Institut (GIUB); Universität Bern.
...
- Jede Gruppe arbeitet mit mindestens drei verschiedenen Datentypen, z.B.:
  ...
  - Abfluss ([Lindas](https://lindas.admin.ch/?lang=en))
  - NDVI (MODIS)
  - Bodenfeuchte (ERA5 oder Stationsdaten)
  - Grundwasser ([Hydrodaten](https://www.hydrodaten.admin.ch/))
  - [TreeNet](https://treenet.info/)

Der Zugang und das Herunterladen der Daten wird in @sec-data erklärt und demonstiert.
...
## Arbeitsaufträge und Leistungsnachweis
