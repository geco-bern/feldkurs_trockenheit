...
iwalk(
  ...
  ~ {
    ...
    destfile <- file.path("data_raw", paste0(safe_name, "_daily.csv"))
...
# create folder
dir.create("data_raw/ch2025", recursive = TRUE, showWarnings = FALSE)
...
walk2(
  ...
  ~ {
    destfile <- file.path("data_raw/ch2025", .y)
    message("Lade ", .y)
